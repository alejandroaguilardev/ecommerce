<div class='modal fade new' tabindex='-1' role='dialog' aria-labelledby='myLargeModalLabel' aria-hidden='true'>  
    <div class='modal-dialog modal-lg modal-dialog-centered'>
        <div class='modal-content'>
        	...
        	<form method="post"  name="new" role="form" action="{{route('adminCategorias.store')}}">
				@csrf
					...
					<div class='row'>
		                <div class='col-md-12'>
							...
							<div class='form-group row'>
	                        	...
	                        	<div class="col-md-6 col-sm-6 ">
	                            	<input type='number' class='form-control form-control-user' name='price_talla' id='new_talla' required   placeholder='Precio por Talla'>
	                        	</div>
	                        </div>
	                        <div class='form-group row'>
